...
router.get('/api/rewards', (req, res) => {
  db.Reward.findAll({}).then((dbReward) => {
    res.json(dbReward);
    res.send('Get rewards from table');
...
router.get('/api/assignedchores/:id', (req, res) => {
  //     // Include needed to get the name of the chore from the chores table
  console.log('Get asigned chores buy ID');
...
router.get('/api/children/points/:id', (req, res) => {
  db.Child.findOne({
    where: {
      id: req.params.id,
    },
...
// FIRST
// First - get the choreId from the assignedchores table
router.get('/api/assignedchores/choreid/:id', (req, res) => {
...
router.get('/api/chores/points/:id', (req, res) => {
  db.Chore.findOne({
    where: {
      id: req.params.id,
    },
...
router.delete('/api/assignedchores/:id', (req, res) => {
...
router.put('/api/children/:id/:chorepoints', (req, res) => {
...
router.post('/api/donechores/:childid/:choreid', (req, res) => {
  db.DoneChore.create({
...
router.post('/api/assignedchores/:childid/:choreid', (req, res) => {
...
router.delete('/api/assignedchores/:childid/:choreid', (req, res) => {
  db.AssignedChore.destroy({
    where: {
      ChildId: req.params.childid,
      ChoreId: req.params.choreid,
...
router.post('/api/usedpoints/:childid/:rewardid', (req, res) => {
  db.UsedPoint.create({
    ChildId: req.params.childid,
